  ...
  .use(function foo() {
    this
      ...
      .prepare(async function() {
        ...
        await foo.make$().data$({id$:'i0',a:1,b:'red',c:9,d:rep(1,'q')}).save$()
        await foo.make$().data$({id$:'i1',a:2,b:'green',c:99,d:rep(2,'q')}).save$()
        await foo.make$().data$({id$:'i2',a:3,b:'blue',c:999,d:rep(1111,'q')}).save$()
      })
  })
